...
{
    public class AnketatEpolls1Controller : Controller
    {
        private readonly PIPOSTEST_Context _context;

        public AnketatEpolls1Controller(PIPOSTEST_Context context)
        {
            _context = context;
        }
